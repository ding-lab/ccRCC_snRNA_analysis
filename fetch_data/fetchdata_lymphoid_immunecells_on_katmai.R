...
# input dependencies ------------------------------------------------------
srat <- readRDS(file = "/diskmnt/Projects/ccRCC_scratch/ccRCC_snRNA/Resources/Analysis_Results/immune/recluster_myel_lymph_20200707/integration.202002012.v3.immune.lymphoid_reclustered20200707.RDS")
...
# write output ------------------------------------------------------------
file2write <- paste0(dir_out, "Metadata.", run_id, ".tsv")
