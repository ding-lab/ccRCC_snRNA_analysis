...
# input dependencies ------------------------------------------------------
path_rds <- "/diskmnt/Projects/Users/rliu/Projects/ccRCC/PT_LOH_subcluster_analysis/snRNA/merged_ccRCC_34_samples/analysis/subcluster_analysis/PT/results/PT_LOH.rds"
...
# write output ------------------------------------------------------------
file2write <- paste0(dir_out, "PT_LOH_Merged.Metadata.", run_id, ".tsv")
