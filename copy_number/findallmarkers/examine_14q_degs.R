...
ora_result <- fread(input = "Ding_Lab/Projects_Current/RCC/ccRCC_snRNA/Resources/Analysis_Results/copy_number/findallmarkers/examine_14q_degs/20200302.v1/ORA_results.tab", data.table = F)
