...
aliquot_show <- "C3L-00088_Merged"
srat <- readRDS(file = "./Data_Freezes/V1/snRNA/Merged_Seurat_Objects/C3L-00088.Tumor_Segments.Merged.20200707.v1.RDS")
...
cnv_state_df <- cnv_state_united_df %>%
  filter(grepl(x = easy_id, pattern = "C3L-00088"))
