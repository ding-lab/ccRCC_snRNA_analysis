...
cnv_region_tab <- fread(paste0("./Ding_Lab/Projects_Current/RCC/ccRCC_snRNA/Resources/snRNA_Processed_Data/InferCNV/outputs/integration.20191021.v1/", snRNA_aliquot_id_tmp, "/HMM_CNV_predictions.HMMi6.rand_trees.hmm_mode-subclusters.Pnorm_0.5.pred_cnv_regions.dat"), data.table = F)
