...
## v2 changes the orders of UMAP and find neighbors, changes the dimension number, changes SCTransform to ScaleData, changes RunPCA npcs from default 50 to 30
## v3, add log normalization step back to v2, didn't differ from v2
## v4, change scale data to SCT based on v3, changes back to not integrated, but not the same as v1
...
pdf(file = file2write, width = 13, height = 6)
