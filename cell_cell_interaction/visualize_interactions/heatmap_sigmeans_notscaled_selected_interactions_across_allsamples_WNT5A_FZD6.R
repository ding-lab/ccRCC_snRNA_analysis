...
#   filter(pair_cell.types %in% c("FZD6_WNT5A.Plasma|Tumor-like epithelial cells", 
#                                 "FZD6_WNT5A.Tumor-like epithelial cells|Tumor-like epithelial cells", 
#                                 "FZD6_WNT5A.Endothelial cells|Tumor-like epithelial cells",
#                                 "FZD6_WNT5A.Tumor cells|Macrophages")) %>%
...
png(file2write, width = 2000, height = 1300, res = 150)
draw(object = p, 
