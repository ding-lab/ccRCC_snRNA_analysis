...
summary_filtered_df <- summary_df %>%
  filter(pair_cell.types %in% c("ANGPT2_TEK.Endothelial cells|Endothelial cells", "ANGPT2_TEK.Myofibroblasts|Endothelial cells", "TEK_ANGPT1.Endothelial cells|Myofibroblasts")) %>%
