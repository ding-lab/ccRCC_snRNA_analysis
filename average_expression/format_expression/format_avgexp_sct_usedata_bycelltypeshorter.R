...
avgexp_df <- fread(data.table = F, input = "./Resources/Analysis_Results/average_expression/averageexpression_sct_usedata_bycelltypeshorter_on_katmai/20200907.v1/averageexpression.SCTslotdata.bycelltype.shorter.31_aliquot_integration.20200907.v1.tsv")
...
# write table -------------------------------------------------------------
file2write <- paste0(dir_out, "formated.", "averageexpression.SCT.slotdata.bycelltype.shorter.31_aliquot_integration.", run_id, ".tsv")
