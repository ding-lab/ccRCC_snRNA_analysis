...
barcode2celltype_df <- fread(input = "./Resources/snRNA_Processed_Data/Cell_Type_Assignment/Integration_AllClusters/ccRCC_metadata_AK_v20201012_scrublet.txt", data.table = F)
...
barcode2celltype_df <- barcode2celltype_df %>%
  mutate(id_bycellgroup_byaliquot = paste0(orig.ident, "_", Cell_type.shorter)) %>%
...
# write output ------------------------------------------------------------
file2write <- paste0(dir_out, "avgexp.", assay_process,".", slot_process, ".bycelltypeshorter.byaliquot.", "31_aliquot_integration.", run_id, ".tsv")
