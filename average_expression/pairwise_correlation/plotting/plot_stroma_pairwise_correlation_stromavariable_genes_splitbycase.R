...
pearson_coef.tumorcellvariable_genes.df <- fread(input = "./Resources/Analysis_Results/average_expression/pairwise_correlation/calculate_stroma_pairwise_correlation_stromacellvariable_genes/20200812.v1/avg_exp_bycellgroup_byaliquot.stroma.stromavaraible_genes.pearson_coef20200812.v1.tsv", data.table = F)
...
## make row annotation
row_left_anno = rowAnnotation(Number_StromaCells = anno_simple(x = number_stromacells_byaliquot$text_range,
