...
pearson_coef_df <- fread(input = "./Resources/Analysis_Results/average_expression/pairwise_correlation/calculate_immune_pairwise_correlation_immunecellvariable_genes/20200811.v1/avg_exp_bycellgroup_byaliquot.immune.immunevaraible_genes.pearson_coef20200811.v1.tsv", data.table = F)
...
## save heatmap as png
png(filename = paste0(dir_out, "avg_exp.immunevariable_genes.pearson_coef.heatmap", ".png"), 
...
## save heatmap as pdf
pdf(file = paste0(dir_out, "avg_exp.immunevariable_genes.pearson_coef.heatmap", ".pdf"), 
    width = 20, height = 16)
draw(object = p, 
     annotation_legend_side = "right", annotation_legend_list = annotation_lgd)
dev.off()
