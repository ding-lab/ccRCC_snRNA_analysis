...
# set plot gene list ------------------------------------------------------
genes_plot <- REACT[["165159	mTOR signalling"]]
...
p <- Heatmap(matrix = plot_data_mat,
             col = heatmapbody_color_fun, row_km = 3, row_km_repeats = 100,
...
# save output -------------------------------------------------------------
file2write <- paste0(dir_out, "pi3k_mtor", "expression.", "tumor_vs_normal_epithelial_cells.", run_id, ".png")
