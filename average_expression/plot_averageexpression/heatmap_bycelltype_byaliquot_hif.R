...
# save output -------------------------------------------------------------
file2write <- paste0(dir_out, "HIF.", "expression.", "tumor_vs_normal_epithelial_cells.", run_id, ".png")
png(filename = file2write, width = 7000, height = 800, res = 150)
draw(object = p, 
