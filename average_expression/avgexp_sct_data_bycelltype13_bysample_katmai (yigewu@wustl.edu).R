...
srat@meta.data$Cell_group13 <- mapvalues(x = srat@meta.data$id_cell, from = barcode2celltype_df$id_cell, to = as.vector(barcode2celltype_df$Cell_group13))
srat@meta.data$Cell_group <- paste0(srat@meta.data$orig.ident, "_", srat@meta.data$Cell_group13)
...
# write output ------------------------------------------------------------
file2write <- paste0(dir_out, "33_aliquot_merged.", "avgexp.", assay_process, ".", slot_process, ".", "bycelltype13_bysample.", run_id, ".tsv")
