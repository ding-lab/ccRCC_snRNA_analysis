...
barcode2celltype_df <- barcode2celltype_df %>%
  mutate(id_bycellgroup_byaliquot = paste0(orig.ident, "_", Cell_group_w_epithelialcelltypes)) %>%
...
# write output ------------------------------------------------------------
file2write <- paste0(dir_out, "avgexp.", assay_process, ".bycellgroup_w_epithelialcelltypes.byaliquot.", run_id, ".tsv")
