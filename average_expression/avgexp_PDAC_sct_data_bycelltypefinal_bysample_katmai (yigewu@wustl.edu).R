...
path_rds <- "/diskmnt/Projects/HTAN_analysis_2/PDAC_Pilot_Additional_Space/Additional_5/Everything_merge_v5_annotated_v3.rds"
...
# set ident ---------------------------------------------------------------
srat@meta.data$Cell_group <- paste0(srat@meta.data$sample_id, "_", srat@meta.data$cell_type_final)
...
# write output ------------------------------------------------------------
file2write <- paste0(dir_out, "PDAC.", "avgexp.", assay_process, ".", slot_process, ".", "cell_type_final.bysample.", run_id, ".tsv")
