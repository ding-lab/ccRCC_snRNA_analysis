...
srat@meta.data$Cell_group <- mapvalues(x = srat@meta.data$id_cell, from = barcode2celltype_df$id_cell, to = as.vector(barcode2celltype_df$Cell_group_w_epithelialcelltypes))
