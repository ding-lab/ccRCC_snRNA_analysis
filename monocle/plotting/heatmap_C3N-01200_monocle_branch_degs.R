...
## input deg table
deg_df <- fread(data.table = F, input = "./Resources/snRNA_Processed_Data/Monocle/outputs/C3N-01200/pseudotime_associated_genes/branch_determining_genes.txt")
...
## write output
file2write <- paste0(dir_out, "Branch", branch_plot, "_CellTypeMarkerChange.png")
png(filename = file2write, width = 1000, height = 400, res = 150)
plot_genes_branched_heatmap(obj_monocle[genes_plot,],
                            branch_point = branch_plot,
                            cores = 1,
                            use_gene_short_name = T,
