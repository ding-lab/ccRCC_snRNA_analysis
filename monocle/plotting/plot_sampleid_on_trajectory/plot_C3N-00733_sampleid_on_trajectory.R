...
obj_monocle <- readRDS(file = "./Resources/snRNA_Processed_Data/Monocle/outputs/CellTypeVer.20200825.v1/C3N-00733_PooledPTCells_ByCellType/combined_subset_pseudotime_qval_1e-10.rds")
...
names(colors_aliquot) <- c("C3N-00733-T1", "C3N-00733-T2", as.vector(aliquot_ids[!(aliquot_ids %in% c("C3N-00733-T1", "C3N-00733-T2"))]))
## plot
