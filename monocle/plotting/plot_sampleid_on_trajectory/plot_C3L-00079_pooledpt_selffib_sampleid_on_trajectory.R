...
colors_aliquot <- c("orange", rep("green", (length(aliquot_ids) - 1)))
names(colors_aliquot) <- c("C3L-00079-T1", as.vector(aliquot_ids[!(aliquot_ids %in% c("C3L-00079-T1"))]))
## plot
...
## write output
file2write <- paste0(dir_out, "Aliquot.snRNA.WU", ".png")
