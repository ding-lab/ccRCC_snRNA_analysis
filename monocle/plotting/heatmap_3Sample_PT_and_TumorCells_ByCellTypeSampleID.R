...
genes_plot <- genes_plot[!(genes_plot %in% c("AK4", "NOX4", "CUBN"))]
...
save_pheatmap_png(x = p, filename = file2write, width = 600, height = 300, res = 150)
file2write <- paste0(dir_out, "Pseudotie_DEG.pdf")
save_pheatmap_pdf(x = p, filename = file2write, width = 3, height = 2)
