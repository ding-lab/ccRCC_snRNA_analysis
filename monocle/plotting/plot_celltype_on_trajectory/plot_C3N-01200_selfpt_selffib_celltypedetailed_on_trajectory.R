...
obj_monocle <- readRDS(file = "./Resources/snRNA_Processed_Data/Monocle/outputs/CellTypeVer.20201002.v1/C3N-01200_SelfPT_SelfFib_ByCellType/combined_subset_pseudotime_qval_1e-10.rds")
...
## plot
p <- plot_cell_trajectory(obj_monocle, color_by = "Cell_group7",cell_size=0.3)
