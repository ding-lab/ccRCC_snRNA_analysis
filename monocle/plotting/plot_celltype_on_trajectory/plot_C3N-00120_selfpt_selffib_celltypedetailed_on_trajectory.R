...
obj_monocle <- readRDS(file = "./Resources/snRNA_Processed_Data/Monocle/outputs/CellTypeVer.20200917.v2/C3N-01200_SelfPT_SelfFib_ByCellType/combined_subset_pseudotime_qval_1e-10.rds")
