...
obj_monocle <- readRDS(file = "./Resources/snRNA_Processed_Data/Monocle/outputs/CellTypeVer.20200917.v2/C3L-00790_PooledPT_SelfFib_ByCellType/combined_subset_pseudotime_qval_1e-10.rds")
