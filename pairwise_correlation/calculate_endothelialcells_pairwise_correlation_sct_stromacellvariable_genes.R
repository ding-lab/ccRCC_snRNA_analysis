...
data_col_names.filtered <- data_col_names.changed[grepl(pattern = "_Endothelial", x = data_col_names.changed)]
...
pearson_coef
write.table(x = pearson_coef, file = paste0(dir_out, "pearson_coef.", "stromavaraible_genes.", "endothelialcells.", "avg_exp.", "sct.", "byaliquot.", run_id, ".tsv"), quote = F, sep = "\t", row.names = T)
