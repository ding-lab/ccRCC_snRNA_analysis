...
pearson_coef.tumorcellvariable_genes.df <- fread(input = "./Resources/Analysis_Results/pairwise_correlation/calculate_endothelialcells_pairwise_correlation_stromacellvariable_genes/20200901.v1/pearson_coef.stromavaraible_genes.endothelialcells.avg_exp.sct.byaliquot.20200901.v1.tsv", data.table = F)
...
## specify cell type
celltype_show <- "Endothelial cells"
## make function
