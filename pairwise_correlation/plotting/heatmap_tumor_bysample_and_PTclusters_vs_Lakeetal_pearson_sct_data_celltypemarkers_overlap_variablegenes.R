...
plot_data_df <- coef_df[rowids_df$cell_type %in% c("PT", "Tumor.cells", "Loop.of.Henle", "Intercalated.cells", "Principle.cells", "Distal.convoluted.tubule"),]
...
p <- Heatmap(matrix = plot_data_mat, 
             ...
             col = col_fun, column_names_side = "top", row_names_side = "left",
...
png(filename = paste0(dir_out, "heatmap", ".png"), 
    width = 1500, height = 2700, res = 150)
draw(object = p, 
