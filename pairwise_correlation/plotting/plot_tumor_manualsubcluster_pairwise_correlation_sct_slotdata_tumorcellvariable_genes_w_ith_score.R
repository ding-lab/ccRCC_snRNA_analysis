...
## input ITH score
ith_score_df <- fread(data.table = F, input = "./Resources/Analysis_Results/tumor_subcluster/calculate_ith_score_assaysct_slotdata/20201201.v1/Mean_Pairwise_Corrleation_TumorSubclusters_By_Case.20201201.v1.tsv")
