...
pearson_coef.tumorcellvariable_genes.df <- fread(input = "./Resources/Analysis_Results/pairwise_correlation/calculate_immune_pairwise_correlation_sct_immunecellvariable_genes/20200901.v1/pearson_coef.stromavaraible_genes.immune.avg_exp.sct.byaliquot.20200901.v1.tsv", data.table = F)
