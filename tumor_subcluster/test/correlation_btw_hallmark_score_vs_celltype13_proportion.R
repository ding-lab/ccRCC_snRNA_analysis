...
celltype_frac_long_df <- fread(data.table = F, input = "./Resources/Analysis_Results/annotate_barcode/count_fraction/count_cellgroup13_fraction_per_sample/20220607.v1/CellGroupBarcodes_Number_and_Fraction_per_Sample20220607.v1.tsv")
...
dir.create(dir_out)
file2write <- paste0(dir_out, "Tumorcluster_score_max_per_sample_vs_celltype13_fraction.", run_id, '.tsv')
