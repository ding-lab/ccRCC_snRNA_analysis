...
cellgroups_test <- unique(celltype_frac_long_df$Cell_group); cellgroups_test <- cellgroups_test[!(cellgroups_test %in% c("Unknown", "Mixed myeloid/lymphoid", "Proximal tubule", "Podocytes", "Principle cells", "Distal convoluted tubule", "Loop of Henle", "Intercalated cells"))]; cellgroups_test
