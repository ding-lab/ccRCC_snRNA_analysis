...
# input dependencies ------------------------------------------------------
# scores_wide_df <- fread(data.table = F, input = "./Resources/Analysis_Results/tumor_subcluster/calculate_scores/calculate_msigdb_top_geneset_scores/20210915.v1/MSigDB.Hallmark.tsv")
