...
# input dependencies ------------------------------------------------------
cnvtype_3ploss_df <- fread(data.table = F, input = "./Resources/Analysis_Results/tumor_subcluster/assign_3ploss_status_by_tumor/20201220.v1/3pLoss_Type_Assignment_Per_Tumor.20201220.v1.tsv")
cnvtype_5qgain_df <- fread(data.table = F, input = "./Resources/Analysis_Results/tumor_subcluster/assign_5qgain_status_by_tumor/20201220.v1/5qGain_Type_Assignment_Per_Tumor.20201220.v1.tsv")
