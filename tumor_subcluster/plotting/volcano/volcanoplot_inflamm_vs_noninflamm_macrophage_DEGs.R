...
# input -------------------------------------------------------------------
deg_df <- fread(data.table = F, input = "./Resources/Analysis_Results/findmarkers/findmarkers_by_celltype/findmarker_wilcox_macrophages_inflamm_tumor_vs_noninflamm_katmai/20220615.v1/logfcthreshold.0.minpct.0.1.mindiffpct.0.tsv")
