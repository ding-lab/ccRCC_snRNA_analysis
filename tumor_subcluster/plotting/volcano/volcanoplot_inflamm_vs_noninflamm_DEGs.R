...
# input -------------------------------------------------------------------
deg_df <- fread(data.table = F, input = "./Resources/Analysis_Results/findmarkers/tumor_subclusters/findmarkers_intrapatienttumorclusters_inflammatory_top_vs_bottom_katmai/20220610.v1/Inflammatory_score_top_vs_bottom_tumorclusters..avg_log2FC.threshold0.min.pct0.1.min.diff.pct0.AssayRNA.tsv")
