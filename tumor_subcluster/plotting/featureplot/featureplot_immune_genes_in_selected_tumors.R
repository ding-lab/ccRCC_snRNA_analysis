...
# genes_plot <- c("HLA-A", "HLA-B", "HLA-C", "HLA-F", "B2M")
# genes_plot <- c("C3", "C1R", "C1S")
# genes_plot <- c("CD74", "HLA-E", "HLA-G", "HLA-DRA", "IL10RA", "INPP5D", "TNFRSF1B", "IL7R", "CD247")
genes_plot <- c("CD47", "CD274")
genes_plot <- c("PTPRC", "CA9", "CXCR4")
