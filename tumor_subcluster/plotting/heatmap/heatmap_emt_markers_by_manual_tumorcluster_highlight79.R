...
emt_genes_df <- fread(data.table = F, input = "./Resources/Analysis_Results/tumor_subcluster/calculate_emt_scores_tumorcells_per_manual_tumorcluster/20201130.v1/EMT_scores_genes.20201130.v1.tsv")
## input emt score pre-calculated
emt_scores_df <- fread(data.table = F, input = "./Resources/Analysis_Results/tumor_subcluster/calculate_emt_scores_tumorcells_per_manual_tumorcluster/20201130.v1/EMT_scores_by_manual_tumorcluster.20201130.v1.tsv")
...
colors_scores_mesenchymal = colorRamp2(c(0, 0.5, 1), 
...
colors_scores_epithelial = colorRamp2(c(0, 2, 4), 
...
pdf(file2write, width = 20, height = 7, useDingbats = F)
draw(object = p, 
     annotation_legend_side = "top", annotation_legend_list = list_lgd)
dev.off()
