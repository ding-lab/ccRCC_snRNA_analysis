...
int_seurat_obj <- readRDS(file = "./Ding_Lab/Projects_Current/RCC/ccRCC_snRNA/Resources/snRNA_Processed_Data/integration/renal_integrated.20190927.v1.RDS")
...
write.table(x = sn_ave_scaled_exp_tab, file = paste0(dir_out, "Average_Scaled_Data_for_Integrated_5FACS.", "20190927.v1",".Run.", run_id, ".tsv"), quote = F, row.names = T, col.names = T, sep = "\t")
...
write.table(x = sn_ave_counts_tab, file = paste0(dir_out, "Average_RNA_Counts_for_Integrated_5FACS.", "20190927.v1", ".Run.", run_id,".tsv"), quote = F, row.names = T, col.names = T, sep = "\t")
...
write.table(x = spearman.test.result.df.sup, 
            file = paste0(dir_out, "Spearman_Correlation_btw_Average_Scaled_snRNA_data_w_bulk_Protein_for_Integrated_5FACS.", "20190927.v1",".Run.", run_id, ".tsv"), 
