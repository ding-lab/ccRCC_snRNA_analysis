...
for (gene_tmp in genes2plot) {
  ...
  tab2p <- NULL
  for (aliquot_id_tmp in c("CPT0001260013", "CPT0001180011", "CPT0010110013", "CPT0019130004", "CPT0086350004")) {
  ...
  rna_mat[gene_tmp, rownames(mat_color)]
  bulk_mrna_col_fun = colorRamp2(0:3, RColorBrewer::brewer.pal(n = 4, name = "YlOrRd"))
