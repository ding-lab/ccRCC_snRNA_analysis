...
# process -----------------------------------------------------------------
final_df <- data.frame(library_ID = c("HT282N1", "HT293N1"),
                       biosample_accession = c("SAMN29632060", "SAMN29632061"),
                       ...
                       filename2 = c("TWCE-HT282N1-S1H3Fs4U1Bp1-HT282N1-S1H3Fs4U1Bp1_2_S1_L004_R2_001.fastq.gz",
...
# write output ------------------------------------------------------------
file2write <- paste0(dir_out, "ST.HumanTissue.SRA_Metadata.", run_id, ".tsv")
