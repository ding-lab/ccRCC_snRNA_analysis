...
clinical_sup_tab <- readxl::read_excel("./Ding_Lab/Projects_Current/CPTAC/CPTAC_Biospecimens_Clinical_Data/CPTAC3_Clinical_Data/CCRCC/CCRCC_Oct2019_flat_file.xlsx")
clinical_sup_tab %>% colnames()

# input the snRNA sample matrix -------------------------------------------
snRNA_sample_mat <- fread(input = "./Ding_Lab/Projects_Current/RCC/ccRCC_snRNA/Resources/Sample_Info/03_Post_request_snRNA_sample_selection/ccRCC_Specimen_Tracking - Case_Matrix.20101017.v1.tsv", data.table = F)
