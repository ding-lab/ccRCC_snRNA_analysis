...
# input dependencies ------------------------------------------------------
## input HIF targets
hif_tf_tab <- fread(input = "./Ding_Lab/Projects_Current/RCC/ccRCC_snRNA/Resources/Analysis_Results/dependencies/write_hif_targets/20200227.v1/HIF_Target_Genes.20200227.v1.tsv", data.table = F)
## input MYC targets
...
## input NRF2 targets
nrf2_tf_tab <- fread(input = "./Ding_Lab/Projects_Current/RCC/ccRCC_snRNA/Resources/Analysis_Results/dependencies/write_nrf2_targets/20200227.v1/NRF2_Target_Genes.20200227.v1.tsv", data.table = F)
## input TP53 targets
