...
integrated_umap_df <- fread(input = "./Resources/Analysis_Results/fetch_data/fetchdata_33_aliquot_merged_katmai/20210506.v1/33AliquotMerged.Metadata.20210506.v1.tsv", data.table = F)
