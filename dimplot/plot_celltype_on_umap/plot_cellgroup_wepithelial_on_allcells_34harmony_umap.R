...
integrated_umap_df <- fread(input = "./Resources/Analysis_Results/integration/harmony_34_ccRCC_samples/20220221.v1/ccRCC.34Sample.Merged.HarmonyIntegrated.Metadata.20220221.v1.tsv", data.table = F)
