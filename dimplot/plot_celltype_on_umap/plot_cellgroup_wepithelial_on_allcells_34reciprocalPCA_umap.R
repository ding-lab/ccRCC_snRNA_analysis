...
integrated_umap_df <- fread(input = "./Resources/Analysis_Results/integration/seuratintegrate_34_ccRCC_samples/reciprocalPCA_integrate_34_ccRCC_samples/20220222.v1/ccRCC.34Sample.Integrated.ReciprocalPCA.Metadata.20220222.v1.tsv", data.table = F)
