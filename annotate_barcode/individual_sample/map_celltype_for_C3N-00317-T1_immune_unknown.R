...
cluster2celltype_df <- readxl::read_excel(path = "./Resources/snRNA_Processed_Data/Cell_Type_Assignment/Individual_Subset/C3N-00317-T1_immune_unknown_reclustered.20210305.xlsx")
## inpus seurat object
srat <- readRDS(file = "./Resources/Analysis_Results/recluster/recluster_cell_groups_in_individual_samples/subset_recluster/subset_C3N-00317-T1_immune_unknown_and_recluster/20210305.v1/C3N-00317-T1.Immune_Unknown.Reclustered.20210305.v1.RDS")
...
# write output ------------------------------------------------------------
file2write <- paste0(dir_out, "C3N-00317-T1.", "Barcode2CellType.", run_id, ".tsv")
