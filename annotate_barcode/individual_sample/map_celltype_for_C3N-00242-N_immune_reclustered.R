...
cluster2celltype_df <- readxl::read_excel(path = "./Resources/snRNA_Processed_Data/Cell_Type_Assignment/Individual_Subset/C3N-00242-N_immune_reclustered.20210802.xlsx")
## inpus seurat object
srat <- readRDS(file = "./Resources/Analysis_Results/recluster/recluster_cell_groups_in_individual_samples/subset_recluster/subset_C3N-00242-N_immune_recluster/20210802.v1/C3N-00242-N.Immune.Reclustered.Res2.RDS")
...
# write output ------------------------------------------------------------
file2write <- paste0(dir_out, "C3N-00242-N.", "Barcode2CellType.", run_id, ".tsv")
