...
cluster2celltype_df <- readxl::read_excel(path = "./Resources/snRNA_Processed_Data/Cell_Type_Assignment/Individual_AllClusters/C3N-00317-T1.20210305.xlsx")
## inpus seurat object
...
barcode2celltype_replace_df <- fread(data.table = F, input = "./Resources/Analysis_Results/annotate_barcode/individual_sample/map_celltype_for_C3N-00317-T1_immune_unknown/20210305.v1/C3N-00317-T1.Barcode2CellType.20210305.v1.tsv")
