...
cluster2celltype_df <- readxl::read_excel(path = "./Resources/snRNA_Processed_Data/Cell_Type_Assignment/Individual_AllClusters/C3N-00437-T1.20210423.xlsx")
## inpus seurat object
srat <- readRDS(file = "./Resources/snRNA_Processed_Data/scRNA_auto/outputs/CPT0012550012/pf1500_fmin200_fmax10000_cmin1500_cmax10000_mito_max0.1/CPT0012550012_processed.rds")
