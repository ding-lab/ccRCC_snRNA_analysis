...
aliquot2process <- "CPT0000880001"
## specify the cluster id
seuratcluster2process <- 5
...
# srat <- subset(srat, idents = "Unknown")
...
# write output ------------------------------------------------------------
file2write <- paste0(dir_out, aliquot2process, ".C", seuratcluster2process, ".CellTypeMarkerExp.png")
