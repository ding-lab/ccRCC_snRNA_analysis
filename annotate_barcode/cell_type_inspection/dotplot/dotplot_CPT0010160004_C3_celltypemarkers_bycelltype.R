...
# cDC                      cDC PDL1/2+                Endothelial cells    Macrophages CD204/CD163/NRP1+         Macrophages CD204/CD163+ 
#   8                                3                                1                                1                               11 
# Macrophages CD204+ Macrophages proliferating MKI67+               Macrophages VEGFA+           Mixed myeloid/lymphoid                   Myofibroblasts 
# 174                                1                               13                                2                                2 
# TRM VSIR+                      Tumor cells                          Unknown 
# 7                                5                              120 
srat <- subset(srat, idents = c("Unknown", "Macrophages CD204+"))
