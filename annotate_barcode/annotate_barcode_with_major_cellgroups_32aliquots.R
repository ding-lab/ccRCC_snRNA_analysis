...
barcode2celltype_patch_df <- fread(data.table = F, input = "./Resources/Analysis_Results/annotate_barcode/individual_sample/map_celltype_for_C3N-00317-T1/20210305.v1/C3N-00317-T1.Barcode2CellType.20210305.v1.tsv")
...
# add patch ---------------------------------------------------------------
barcode2celltype_df <- rbind(barcode2celltype_patch_df, barcode2celltype_df)
...
# write output ------------------------------------------------------------
## final check up
nrow(barcode2celltype_df) # 144574
file2write <- paste0(dir_out, "32Aliquot.Barcode2CellType.", run_id, ".tsv")
