...
# add patch ---------------------------------------------------------------
barcode2celltype_df <- rbind(barcode2celltype_patch_df2, barcode2celltype_patch_df1, barcode2celltype_df)
...
# write output ------------------------------------------------------------
## final check up
nrow(barcode2celltype_df) # 150253
file2write <- paste0(dir_out, "33Aliquot.Barcode2CellType.", run_id, ".tsv")
