...
# input dependencies ------------------------------------------------------
## input seurat paths
renal.integrated <- readRDS(file = "./Resources/Analysis_Results/merging/merge_32_aliquot/20210315.v1/32_aliquot.merged.20210315.v1.RDS")
...
## save as RDS file
saveRDS(object = renal.integrated, file = paste0(dir_out, "32_aliquot.SCTransform.", run_id, ".RDS"), compress = T)
