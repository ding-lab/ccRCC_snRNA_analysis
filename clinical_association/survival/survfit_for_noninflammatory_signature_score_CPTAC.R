...
# input dependencies ------------------------------------------------------
## input scores
exp_df <- fread(data.table = F, input = "./Resources/Analysis_Results/bulk/expression/rna/other/preprocess/calculate_noninflammatory_signature_score/20220612.v1/tumorcell_intrinsic_inflammation_signature_scores.20220612.v1.tsv")
...
res <- ggsurvplot(fit_efs,
                  ...
                  legend.title = paste0("non-inflammatory\nsignature score\n(mRNA)"),
