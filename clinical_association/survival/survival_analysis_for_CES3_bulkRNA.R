...
exp_df <- fread(data.table = F, input = "~/Box/CPTAC_ccRCC/Data_Freeze_1.1/CPTAC_ccRCC_Discovery/Gene_expression/CPTAC_ccRCC_discovery_tumor_mRNA_FPKM_UQ_log2_v1.0.tsv")
...
cutoff_exp <- quantile(x = testdata_df$Expression, probs = 0.25, na.rm = T)
