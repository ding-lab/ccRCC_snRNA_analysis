...
case_clinical_df$Followup_New_Tumor_Event_Sim <- get_yes_no(response_string = case_clinical_df$Followup_New_Tumor_Event)
...
for (cellgroup_tmp in unique(cellgroupfrac_df$Cell_group)) {
  ...
  plot_data_df$Followup_New_Tumor_Event_Sim <- mapvalues(x = plot_data_df$Case, from = case_clinical_df$Case, to = as.vector(case_clinical_df$Followup_New_Tumor_Event_Sim))
  ...
  plot_data_df <- plot_data_df %>%
    mutate(x_plot = Followup_New_Tumor_Event_Sim) %>%
