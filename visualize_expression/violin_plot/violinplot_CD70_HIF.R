...
quantile(plot_tmpdata_df$value_x, probs = 0.25)
quantile(plot_tmpdata_df$value_x, probs = 0.50)
quantile(plot_tmpdata_df$value_x, probs = 0.75)

plot_tmpdata_df <- plot_tmpdata_df %>%
  mutate(value_x_bin = cut(value_x, breaks = c(0, 0.70, 1.10, 1.40, 3.3)))
