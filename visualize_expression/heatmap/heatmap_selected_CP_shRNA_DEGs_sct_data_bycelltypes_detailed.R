...
genes_filter <- c("OSMR", "IL6ST", "OSM", 
                  ...
                  "TNFSF10", "TNFRSF10B",
                  "ANGPTL4")
genes_filter <- c("CD70", "CD27", "OSM", "OSMR", "IL6ST")
genes_filter <- c("CD44", "ENO2", "TGFBI", "TGM2", "ITGB1", "ITGB5", "FN1", "SDC4", "VIM", "C1R", "C1S", "MT2A", "CEBPD", "PFKFB3", "OSMR", "ANXA1")
genes_filter <- c("CP", "OSMR", "OSM", "TGM2", "FN1", "VEGFA")
