...
# make row split ----------------------------------------------------------
row_split_vec <- mapvalues(x = rownames_plot, from = gene2pathway_df$GeneSymbol, to = as.vector(gene2pathway_df$GeneSet_Name))
...
p <- ComplexHeatmap::Heatmap(matrix = plot_data_mat, 
                             ...
                             ## row
                             show_row_names = F, row_names_gp = gpar(fontsize = 10, fontface = "italic"), row_names_side = "left",
...
png(file2write, width = 3000, height = 6000, res = 150)
draw(object = p, 
