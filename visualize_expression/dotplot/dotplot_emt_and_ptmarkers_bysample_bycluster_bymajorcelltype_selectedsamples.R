...
for (aliquot2process in unique(paths_srat_df$Aliquot)) {
  # for (aliquot2process in c("CPT0001260013", "CPT0001180011", "CPT0079410004", "CPT0075140002", "CPT0075130004", "CPT0075120002")) {
  ...
  ## decide on the plot height
  n_x <- length(unique(plotdata_df$id))
  height_plot <- ifelse(n_x <=8, 800, 1200)
