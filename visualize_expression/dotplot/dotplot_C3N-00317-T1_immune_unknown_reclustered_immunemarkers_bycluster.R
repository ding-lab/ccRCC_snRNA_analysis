...
gene2celltype_df <- fread(data.table = F, input = "./Resources/Analysis_Results/immune/Immune_state/Cell_state_markers.txt")
...
gene2celltype_df <- gene2celltype_df %>%
  filter(Expression_direction != "negative" & Expression_direction != "low")
