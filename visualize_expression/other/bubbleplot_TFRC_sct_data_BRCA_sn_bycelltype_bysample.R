...
exp_long_df <- fread(data.table = F, input = "./Resources/snRNA_Processed_Data/Others/0.expression_meta_BRCA.txt")
...
plotdata_df <- rbind(plotdata_df[plotdata_df$cell_group != "Mono_Macro",], plotdata_df[plotdata_df$cell_group == "Mono_Macro",])
## make colors
...
# file2write <- paste0(dir_out, "BRCA_TFRC", ".png")
# png(file2write, width = 1200, height = 1000, res = 150)
# print(p)
# dev.off()
file2write <- paste0(dir_out, "BRCA_TFRC", ".pdf")
