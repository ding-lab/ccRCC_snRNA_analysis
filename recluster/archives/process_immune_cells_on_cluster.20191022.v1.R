...
# set parameters ----------------------------------------------------------
dir_out_parent <- paste0(dir_recluster_results, "process_immune_cells_on_cluster/")
...
renal.int.object <- subset(renal.int.object, idents = immune_clusters)
...
saveRDS(object = renal.int.immune.obj, file = paste0(dir_out, "NonImmune_Integrated.", run_id, ".RDS"))
