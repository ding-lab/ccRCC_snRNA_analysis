...
path_rds <- "./Resources/snRNA_Processed_Data/scRNA_auto/outputs/CPT0078510004/pf1200_fmin200_fmax10000_cmin1200_cmax10000_mito_max0.1/CPT0078510004_processed.rds"
srat <- readRDS(file = path_rds)
print("Finish reading RDS file")
## name of the cell group to recluster
table(srat@meta.data$seurat_clusters)
clusters2process <- c(8, 9, 10)
