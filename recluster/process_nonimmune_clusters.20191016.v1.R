...
dir.create(dir_out)
snRNA_aliquot_ids <- c("CPT0075140002", "CPT0001260013", "CPT0086350004")

# Input the seurat object -------------------------------
renal.int.object <- readRDS(file = "./Ding_Lab/Projects_Current/RCC/ccRCC_snRNA/analysis_results/integration/integrate_seurat_objects/20191002.v1/renal_integrated20191002.v1.RDS")

# input cell type assignment table ----------------------------------------
cluster2celltype_tab <- fread(input = "./Ding_Lab/Projects_Current/RCC/ccRCC_snRNA/Resources/snRNA_Processed_Data/Cell_Type_Assignment/RCC_snRNA_Downstream_Processing - Cluster2Cell_Type_Assignment.20191002.v1.tsv", data.table = F)
...
gene2cellType_tab <- fread(input = "./Ding_Lab/Projects_Current/RCC/ccRCC_snRNA/Resources/Kidney_Markers/RCC_marker_gene_table_and_literature_review - Gene2CellType_Tab_w.HumanProteinAtlas.20191003.v1.tsv")
