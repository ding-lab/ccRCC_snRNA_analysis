...
renal.int.object <- readRDS("./Ding_Lab/Projects_Current/RCC/ccRCC_snRNA/analysis_results/integration/integrate_seurat_objects/20191015.v1/Renal_Integrated.20191015.v1.RDS")
snRNA_aliquot_ids <- unique(renal.int.object@meta.data$orig.ident)
snRNA_aliquot_ids


# input cell type assignment table ----------------------------------------
cluster2celltype_tab <- fread(input = "./Ding_Lab/Projects_Current/RCC/ccRCC_snRNA/Resources/snRNA_Processed_Data/Cell_Type_Assignment/RCC_snRNA_Downstream_Processing - Cluster2Cell_Type_Assignment.20191017.v1.tsv", data.table = F)
