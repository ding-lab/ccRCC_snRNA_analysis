...
seurat_summary <- fread(input = "./Resources/snRNA_Processed_Data/scRNA_auto/summary/ccRCC_snRNA_Downstream_Processing - Seurat_Preprocessing.20200701.v1.tsv", data.table = F)
...
# Merge Data -----------------------------------------------------------
renal.merged <- merge(renal.list[[1]], renal.list[[2]], project = "Merged")
renal.merged <- merge(renal.merged, renal.list[[3]], project = "Merged")
