...
gene2cellType_tab <- fread(input = "./Ding_Lab/Projects_Current/RCC/ccRCC_single_cell/Resources/Kidney_Markers/RCC_literature_review_and_marker_gene_table - Gene_to_Cell_Type_Table_20190910_v1.tsv")
