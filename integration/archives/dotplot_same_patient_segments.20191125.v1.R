...
for (case_id_tmp in case_ids) {
  if (case_id_tmp == "C3N-00733") {
    ...
    deg_tab_path <- paste0("./Ding_Lab/Projects_Current/RCC/ccRCC_snRNA/Resources/Analysis_Results/integration/run_deg_same_patient_segments/20191125.v1/", case_id_tmp, ".Tumor_Segments.DEGs.Pos.txt")
  }
