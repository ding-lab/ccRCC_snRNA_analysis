...
srat <- readRDS("/diskmnt/Projects/ccRCC_scratch/Resources/Analysis_Results/integration/30_aliquot_integration/docker_run_integration/20200212.v3/30_aliquot_integration.20200212.v3.RDS")
...
write.table(x = umap_data, file = paste0(dir_out, "30_aliquot_integration.", run_id, ".umap_data.tsv"), quote = F, row.names = F, sep = "\t")
