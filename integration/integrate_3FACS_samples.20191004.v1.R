...
# make the data frame listing the seurat object paths ---------------------
...
renal.integrated <- readRDS(file = "./Ding_Lab/Projects_Current/RCC/ccRCC_single_cell/analysis_results/integration/integrate_seurat_objects/20191002.v1/renal_integrated20191002.v1.RDS")
...
renal.markers <- fread(input = "./Ding_Lab/Projects_Current/RCC/ccRCC_single_cell/analysis_results/integration/integrate_seurat_objects/20191002.v1/Renal.DEGs.Pos.CellTypeMarkerOnly.20191002.v1.txt", data.table = F)
...
file2write <- paste0(dir_out, "Dotplot_AllClusters_Marker_Exp.", run_id, ".pdf")
pdf(file2write, width = 22, height = 8)
print(p)
dev.off()
