...
easyids[cases %in% mut_df$Case[mut_df$mutation_category_sim == "PBRM1 mutated"]]
paths_file_process <- paths_deg_file[cases %in% mut_df$Case[mut_df$mutation_category_sim == "PBRM1 mutated"]]
