...
# make plot data ----------------------------------------------------------
plot_data_df <- deg_df %>%
  # filter(BAP1_vs_PBRM1_Mutants_snRNA != "Inconsistent" | BAP1_vs_NonMutants_snRNA != "Inconsistent" | BAP1_Tumorcells_vs_PTcells_snRNA != "Inconsistent") %>%
  select(genesymbol_deg, BAP1_vs_PBRM1_Mutants_snRNA, BAP1_vs_NonMutants_snRNA, BAP1_Tumorcells_vs_PTcells_snRNA) %>%
...
p
# write output ------------------------------------------------------------
file2write <- paste0(dir_out, "BAP1.", "Number_DEGs_byDirection.", "png")
