...
# input dependencies ------------------------------------------------------
## input degs
deg_df <- fread(data.table = F, input = "./Resources/Analysis_Results/findmarkers/tumor_subclusters/findmarkers_C3L-00079-T1_EMT_vs_nonEMT_tumorcells_doublets_removed_katmai/20210803.v1/findmarkers.wilcox.EMT_vs_nonEMT_tumorcells.logfcthreshold0.minpct0.1.mindiffpct0.1.tsv")
