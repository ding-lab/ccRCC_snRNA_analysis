...
markers_wilcox_df$ident2 <- cluster2

# write output ------------------------------------------------------------
file2write <- paste0(dir_out, "C3N-00010.correlatedtumorcells.FindAllMarkers.newcluster0vs1.Wilcox.Minpct", min.pct.wilcox, ".Logfc", logfc.threshold.wilcox,".tsv")
