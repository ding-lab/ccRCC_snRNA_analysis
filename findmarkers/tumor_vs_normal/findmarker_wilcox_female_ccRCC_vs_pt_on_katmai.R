...
# dir_base = "~/Box/Ding_Lab/Projects_Current/RCC/ccsRCC_snRNA/"
setwd(dir_base)
...
# preprocess ----------------------------------------
cases_process <- clinical_bycase_df$Case[clinical_bycase_df$Gender == case_feature]
aliquots_tumor <- idmetadata_df$Aliquot.snRNA[idmetadata_df$snRNA_available & idmetadata_df$Sample_Type == "Tumor" & idmetadata_df$Case != "C3L-00359" & idmetadata_df$Case %in% cases_process]
aliquots_tumor
aliquots_nat <- idmetadata_df$Aliquot.snRNA[idmetadata_df$snRNA_available & idmetadata_df$Sample_Type == "Normal" & idmetadata_df$Case %in% cases_process]
aliquots_nat
...
## write output
file2write <- paste0(dir_out, case_feature, ".ccRCC.", test_process, 
