...
degs_df <- fread(input = paste0("./Resources/Analysis_Results/findmarkers/tumor_vs_normal/findmarker_roc_CPT0075720013_tumor_vs_normalpt_on_katmai/20200414.v1/findmarkers_roc.CPT0075720013tumor_vs_normalpt.20200414.v1.tsv"), data.table = F)
