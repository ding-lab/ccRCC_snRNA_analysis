...
isallup_vec <- (deg_wide_df$`C3L-00416-T2`>0 & deg_wide_df$`C3L-01313-T1`>0 & deg_wide_df$`C3N-01200-T1`>0)
isalldown_vec <- (deg_wide_df$`C3L-00416-T2`<0 & deg_wide_df$`C3L-01313-T1`<0 & deg_wide_df$`C3N-01200-T1`<0)
...
# write output ------------------------------------------------------------
file2write <- paste0(dir_out, "DEGs_bap1mutant_snatac_tumors", ".tsv")
