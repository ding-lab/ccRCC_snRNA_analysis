...
# input dependencies ------------------------------------------------------
deg_cnvcor_df <- fread(data.table = F, input = "./Resources/Analysis_Results/findmarkers/tumor_vs_normal/findmarker_LR_wCNV_all_ccRCC_vs_pt_on_katmai/20210608.v1/LR.logfc.threshold0.1.min.pct0.1.min.diff.pct0.1.AssayRNA.tsv")
deg_df <- fread(data.table = F, input = "./Resources/Analysis_Results/findmarkers/tumor_vs_normal/findmarker_LR_all_ccRCC_vs_pt_on_katmai/20210607.v1/LR.logfc.threshold0.1.min.pct0.1.min.diff.pct0.1.AssayRNA.tsv")
...
# write output ------------------------------------------------------------
file2write <- paste0(dir_out, "LR.logfc.threshold0.1.min.pct0.1.min.diff.pct0.1.AssayRNA.tsv")
