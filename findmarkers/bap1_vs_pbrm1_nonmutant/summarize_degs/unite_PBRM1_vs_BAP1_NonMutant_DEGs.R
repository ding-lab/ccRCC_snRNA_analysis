...
dirname_deg_files <- c("./Resources/Analysis_Results/findmarkers/bap1_vs_pbrm1_nonmutant/findallmarker_wilcox_PBRM1_tumor_vs_BAP1_NonMutant_on_katmai/20210616.v1/")
