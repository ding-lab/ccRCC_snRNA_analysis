...
deg_bulkprotein_df <- fread(data.table = F, input = "./Resources/Analysis_Results/bulk/expression/compare_bulk_protein_BAP1_tumor_vs_othertumors/20210616.v1/Bulk_Protein_BAP1_vs_Others.Wilcox.20210616.v1.tsv")
