...
p <- p + ylim(c(0, 25))
p <- p + ggtitle(paste0("Significant Down DEGS"), subtitle = ">= 5 BAP1-vs-other-tumor comparisons & CNV corrected")
file2write <- paste0(dir_out, "Down_DEGs.bychr.CNVcorrected.png")
