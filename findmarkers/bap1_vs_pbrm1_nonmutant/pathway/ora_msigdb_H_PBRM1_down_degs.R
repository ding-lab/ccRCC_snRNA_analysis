...
## input degs
deg_all_df <- fread(data.table = F, input = "./Resources/Analysis_Results/findmarkers/bap1_vs_pbrm1_nonmutant/summarize_degs/summarize_PBRM1_vs_BAP1_NonMutant_DEGs/20210430.v1/PBRM1_DEGs.Consistent20210430.v1.tsv")

# convert gene symbol to entrez ids ---------------------------------------
deg_df <- deg_all_df %>%
  filter(PBRM1_vs_OtherTumor_snRNA == "Down") %>%
