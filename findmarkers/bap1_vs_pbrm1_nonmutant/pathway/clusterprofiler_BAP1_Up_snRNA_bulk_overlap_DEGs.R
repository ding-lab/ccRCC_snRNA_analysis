...
## input degs
### 2021-04-05
deg_all_df <- fread(data.table = F, input = "./Resources/Analysis_Results/findmarkers/bap1_vs_pbrm1_nonmutant/summarize_degs/overlap_BAP1_snRNA_bulkRNA_DEGs/20210407.v1/BAP1_DEGs.Overlap.snRNA_and_bulkRNA.20210407.v1.tsv")
...
deg_df <- deg_all_df %>%
  filter(BAP1_vs_OtherTumor_snRNA == "Up")
...
## get gene list
avg_logFC_df$avg_logFC_BAP1_vs_others <- rowMeans(avg_logFC_df[, c("BAP1_Tumorcells_vs_PTcells_Up", "BAP1_vs_NonMutants_Tumorcells_Up", "BAP1_vs_PBRM1_Mutants_Tumorcells_Up")])
