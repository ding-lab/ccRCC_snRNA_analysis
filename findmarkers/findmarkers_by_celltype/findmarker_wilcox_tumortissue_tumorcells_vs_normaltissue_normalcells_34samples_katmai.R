...
# preprocess --------------------------------------------------------------
aliquots_group1<- metadata_df$Aliquot.snRNA[metadata_df$Sample_Type == "Tumor" & metadata_df$snRNA_available & metadata_df$Case != "C3L-00359"]
aliquots_group2<- metadata_df$Aliquot.snRNA[metadata_df$Sample_Type == "Normal" & metadata_df$snRNA_available & metadata_df$Case != "C3L-00359"]
...
table(Idents(srat))
idents_group1 <- paste0(aliquots_group1, "_", idents_group1)
idents_group2 <- paste0(aliquots_group2, "_", idents_group2)
