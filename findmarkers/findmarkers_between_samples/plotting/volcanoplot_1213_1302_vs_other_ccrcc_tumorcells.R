...
# save output -------------------------------------------------------------
file2write <- paste0(dir_out, "volcanoplot.", "1213_1302_vs_other_ccrcc_tumorcells.", ".pdf")
pdf(file = file2write, width = 8, height = 6, useDingbats = F)
print(p)
dev.off()

file2write <- paste0(dir_out, "volcanoplot.", "1213_1302_vs_other_ccrcc_tumorcells.", ".png")
