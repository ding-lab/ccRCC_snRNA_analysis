...
# write output ------------------------------------------------------------
file2write <- paste0(dir_out, "Germline_Variants.", "snRNA.", "pickCaller.", "Merged.", run_id, ".tsv")
write.table(x = vcf_merged_df, file = file2write, quote = F, sep = "\t", row.names = F)
file2write <- paste0(dir_out, "Germline_Variants.", "snRNA.", "pickCaller.", "Shared_Variants.", run_id, ".tsv")
