...
vaf_snrna_df <- fread(data.table = F, input = "./Resources/Analysis_Results/mutation/identity_check/calculate_vaf/calculate_vaf_for_snrna_germline_variants/20200707.v1/Germline_Variants.snRNA.pickCaller.Shared_Variants.VAF.20200707.v1.tsv")
...
# identify shared variants between snrna and snatac------------------------------------------------
## filter by VAF
...
variants_shared <- intersect(variants_snrna, variants_snatac)
...
cor_coef %>% head()
# write output ------------------------------------------------------------
file2write <- paste0(dir_out, "Correlation_Coeffcients.", "snATAC_vs_snrna.", "snATAC_Cases.", run_id, ".RDS")
