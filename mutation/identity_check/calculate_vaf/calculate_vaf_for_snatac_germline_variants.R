...
vcf_df <- fread(data.table = F, input = "./Resources/Analysis_Results/mutation/identity_check/intersect_snatac_germline_variants/20200706.v1/Germline_Variants.snATAC.pickCaller.Shared_Variants.20200706.v1.tsv")
...
# write output ------------------------------------------------------------
file2write <- paste0(dir_out, "Germline_Variants.", "snATAC.", "pickCaller.", "Shared_Variants.", "VAF.", run_id, ".tsv")
