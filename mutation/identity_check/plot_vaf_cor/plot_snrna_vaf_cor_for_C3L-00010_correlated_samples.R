...
plot_data_mat <- readRDS(file = "./Resources/Analysis_Results/mutation/identity_check/calculate_vaf_cor/calculate_snrna_vaf_cor_for_selectedsamples/20200820.v1/Correlation_Coeffcients.snRNA.SelectedSamples.20200820.v1.RDS")
plot_data_mat
...
# write output ------------------------------------------------------------
## save heatmap as png
file2write <- paste0(dir_out, "snRNA_vaf_cor_for_selected_samples.", ".png")
