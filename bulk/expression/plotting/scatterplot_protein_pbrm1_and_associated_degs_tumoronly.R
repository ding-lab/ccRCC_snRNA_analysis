...
## input filtered deg
gene_x <- "PBRM1"
genes_y <- c("OGFRL1", "CCNG1", "SNX33", "TSC22D4", "FSTL3", "ZNF354B", "NAMPT", "JPH2", "SLC16A12", "NSD1", "IFRD1", "IFIT3", "ARRDC2", "SH3TC1", "HIP1", "LPIN2", "PSPH", "LUC7L2", "SP4")
...
aliquotids_plot <- meta_df$Specimen.Label[!is.na(meta_df$Type) & meta_df$Type == "Tumor"]
