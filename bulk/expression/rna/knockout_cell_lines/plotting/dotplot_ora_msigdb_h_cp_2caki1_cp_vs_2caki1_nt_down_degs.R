...
enricher_out_df <- fread(data.table = F, input = "./Resources/Analysis_Results/bulk/expression/rna/knockout_cell_lines/pathway_analysis/prioritize_ora_msigdb_h_cp_results_2caki1_cp_vs_2caki1_nt/20220525.v1/ora_msigdb_h_cp_2caki1_cp_vs_2caki1_nt_degs.processed.sig.20220525.v1.tsv")
