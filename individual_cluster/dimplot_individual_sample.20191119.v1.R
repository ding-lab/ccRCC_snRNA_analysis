...
cluster2celltype_tab <- fread(input = "./Ding_Lab/Projects_Current/RCC/ccRCC_snRNA/Resources/snRNA_Processed_Data/Cell_Type_Assignment/ccRCC_snRNA_Downstream_Processing - Individual.AllCluster2Cell_Type.20191119.v1.tsv", data.table = F)
...
for (snRNA_aliquot_id_tmp in snRNA_aliquot_ids) {
  ...
  file2write <- paste(dir_out, snRNA_aliquot_id_tmp, ".Dimplot.", run_id, ".png", sep="")
