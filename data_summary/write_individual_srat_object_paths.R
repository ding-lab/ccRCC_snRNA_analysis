...
seurat_summary <- fread(input = "./Resources/snRNA_Processed_Data/scRNA_auto/summary/ccRCC_snRNA_Downstream_Processing - Seurat_Preprocessing.20200219.v1.tsv", data.table = F)
