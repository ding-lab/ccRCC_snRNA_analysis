...
peaks_df <- fread(data.table = F, input = "./Resources/Analysis_Results/snatac/da_peaks/findmarkers/findmarker_786O_celllines/20210610.v1/DA_Peaks.BAP1_vs_Control.786O_CellLines.min.diff.pct.0min.pct.0.1logfc.threshold.0.tsv")
