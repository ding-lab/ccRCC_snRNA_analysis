...
# input dependencies ------------------------------------------------------
## input all dap + caps
peaks_up_df <- fread(data.table = F, input = "./Resources/snATAC_Processed_Data/Differential_Peaks/PBRM1_Specific/UP_PBRM1_vsNonMutants.Filtered.CNV_corrected.Annotated.20210623.tsv")
peaks_down_df <- fread(data.table = F, input = "./Resources/snATAC_Processed_Data/Differential_Peaks/PBRM1_Specific/DOWN_PBRM1_vsNonMutants.Filtered.CNV_corrected.Annotated.20210623.tsv")
## input peak fold changes
peak2foldchange_df <- fread(data.table = F, input = "./Resources/snATAC_Processed_Data/Differential_Peaks/PBRM1_Specific/PBRM1_vsNon_mutants.Filtered_peaks_byMinPct.0.1.tsv")
