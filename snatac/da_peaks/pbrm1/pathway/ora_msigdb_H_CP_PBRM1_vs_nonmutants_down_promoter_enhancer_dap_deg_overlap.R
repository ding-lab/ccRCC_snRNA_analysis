...
## input degs
daps_df <- fread(data.table = F, input = "./Resources/Analysis_Results/snatac/da_peaks/pbrm1/overlap_degs/overlap_pbrm1_vs_nonmutant_enhancer_promoter_peaks_with_degs/20210628.v1/PBRM1_vs_NonMutant_DAP2DEG.20210628.v1.tsv")
