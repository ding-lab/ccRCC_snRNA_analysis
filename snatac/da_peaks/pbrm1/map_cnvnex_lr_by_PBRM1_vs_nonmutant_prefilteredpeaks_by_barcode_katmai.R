...
## input peaks
peaks_df <- fread(data.table = F, input = "./Resources/snATAC_Processed_Data/Differential_Peaks/PBRM1_Specific/PBRM1_vsNon_mutants.Filtered_peaks_byMinPct.0.1.tsv")
...
# write table -------------------------------------------------------------
file2write <- paste0(dir_out, "Barcode2PBRM1PrefilteredPeak.CNV.", run_id, ".RDS")
