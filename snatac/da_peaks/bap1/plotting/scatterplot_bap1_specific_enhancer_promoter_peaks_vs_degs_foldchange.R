...
# input dependencies ------------------------------------------------------
peaks2degs_df <- fread(data.table = F, input = "./Resources/Analysis_Results/snatac/da_peaks/bap1/overlap_bap1_specific_enhancer_promoter_peaks_with_degs/20210615.v1/BAP1_DAP2DEG.20210615.v1.tsv")
...
plotdata_df <- plotdata_df %>%
  mutate(highlight = (Gene %in% c("PTPRJ", "DLC1", "COL6A2") | (Gene == "DDIT4" & peak2gene_type == "Promoter") | (Gene == "CES3" & avg_log2FC.snATAC < -1.5)))
...
# print(p)
# dev.off()
file2write <- paste0(dir_out, "scatterplot_snATAC_snRNA_FC.","PTPRJ_CES3_DDIT4",".pdf")
