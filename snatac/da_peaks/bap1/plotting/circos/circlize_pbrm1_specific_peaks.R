...
# input dependencies ------------------------------------------------------
peaks_df <- fread(data.table = F, input = "./Resources/Analysis_Results/snatac/da_peaks/bap1/annotate_pbrm1_specific_daps/20210616.v1/PBRM1_DAPs.Annotated.20210616.v1.tsv")
...
# plot version 1 --------------------------------------------------------------------
## initialize
file2write <- paste0(dir_out, "PBRM1_specific_peaks.pdf")
