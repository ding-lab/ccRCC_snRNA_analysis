...
## input degs
daps_df <- fread(data.table = F, input = "./Resources/Analysis_Results/snatac/da_peaks/pbrm1/annotate_pbrm1_vs_nonmutant_daps/20210625.v1/PBRM1_DAP2Gene.EnhancerPromoter.20210625.v1.tsv")
...
entrezgene_ids_universe <- unique(peaks_background_df$entrezgene_id[peaks_background_df$peak2gene_type == "Enhancer"])
