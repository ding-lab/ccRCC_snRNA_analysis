...
pathway2genes_df1 <- fread(data.table = F, input = "./Resources/Analysis_Results/snatac/da_peaks/bap1/pathway/ora_msigdb_H_CP_BAP1_vs_NonMutant_down_daps_promoter_enhancer/20210625.v1/ORA_Results.tsv")
pathway2genes_df2 <- fread(data.table = F, input = "./Resources/Analysis_Results/snatac/da_peaks/bap1/pathway/ora_msigdb_H_CP_BAP1_vs_NonMutant_up_daps_promoter_enhancer/20210625.v1/ORA_Results.tsv")
pathway2genes_df3 <- fread(data.table = F, input = "./Resources/Analysis_Results/snatac/da_peaks/bap1/pathway/ora_msigdb_H_CP_PBRM1_vs_NonMutant_down_daps_promoter_enhancer/20210625.v1/ORA_Results.tsv")
pathway2genes_df4 <- fread(data.table = F, input = "./Resources/Analysis_Results/snatac/da_peaks/bap1/pathway/ora_msigdb_H_CP_PBRM1_vs_NonMutant_up_daps_promoter_enhancer/20210625.v1/ORA_Results.tsv")
...
pathway_selected <- c("HALLMARK_MTORC1_SIGNALING", "REACTOME_RHO_GTPASE_CYCLE", "REACTOME_DNA_DOUBLE_STRAND_BREAK_RESPONSE", "WP_INSULIN_SIGNALING",
                      "REACTOME_EXTRACELLULAR_MATRIX_ORGANIZATION", "HALLMARK_HYPOXIA",
                      "WP_FOCAL_ADHESION", "REACTOME_RAC1_GTPASE_CYCLE", "HALLMARK_HYPOXIA", "BIOCARTA_CARDIACEGF_PATHWAY")
