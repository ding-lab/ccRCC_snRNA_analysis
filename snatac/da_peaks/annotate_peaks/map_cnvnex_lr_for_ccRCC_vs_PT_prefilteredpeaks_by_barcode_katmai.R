...
## input peaks
peaks_df <- fread(data.table = F, input = "./Resources/snATAC_Processed_Data/Differential_Peaks/ccRCC_Specific/ccRCC_specific_Filtered_peaks_byMinPct.0.1.tsv")
...
# write table -------------------------------------------------------------
file2write <- paste0(dir_out, "Barcode2ccRCC_vs_PT_PrefilteredPeak.CNV.", run_id, ".RDS")
