...
## input peaks
peaks_df <- fread(data.table = F, input = "./Resources/snATAC_Processed_Data/Differential_Peaks/BAP1_Specific/BAP1_vsNon_mutants.Filtered_peaks_byMinPct.0.1.20210712.tsv")
...
# write table -------------------------------------------------------------
file2write <- paste0(dir_out, "Barcode2BAP1_vs_Nonmutants_PrefilteredPeak.CNV.", run_id, ".RDS")
