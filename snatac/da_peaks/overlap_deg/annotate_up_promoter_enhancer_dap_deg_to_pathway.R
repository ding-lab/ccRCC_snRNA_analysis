...
# input dependencies ------------------------------------------------------
##input overlap
deg_df <- fread(data.table = F, input = "./Resources/Analysis_Results/snatac/da_peaks/overlap_deg/overlap_up_dap_w_up_snRNA_bulk_degs/20210510.v2/Up_PromoterEnhancer_DAP.Overlap.Up_snRNA_bulk_DEGs.20210510.v2.tsv")
...
# write output ------------------------------------------------------------
file2write <- paste0(dir_out, "Up_ProEnh_DAP.Overlap.Up_snRNA_bulk_DEGs.20210510.v1.tsv")
