...
isallup_vec <- (dam_wide_df$`C3L-00088-T1`>0 & dam_wide_df$`C3L-00088-T2`>0 & dam_wide_df$`C3L-00917-T1`>0 & dam_wide_df$`C3L-00448-T1`>0)
isalldown_vec <- (dam_wide_df$`C3L-00088-T1`<0 & dam_wide_df$`C3L-00088-T2`<0 & dam_wide_df$`C3L-00917-T1`<0 & dam_wide_df$`C3L-00448-T1`<0)
...
# write output ------------------------------------------------------------
file2write <- paste0(dir_out, "DAMs_nonmutant_snatac_tumors", ".tsv")
