...
isallup_vec <- (dam_wide_df$`C3L-00610-T1` >0 & dam_wide_df$`C3N-00733-T1`>0)
isalldown_vec <- (dam_wide_df$`C3L-00610-T1` <0 & dam_wide_df$`C3N-00733-T1`<0)
...
# write output ------------------------------------------------------------
file2write <- paste0(dir_out, "DAMs_pbrm1mutant_snatac_tumors", ".tsv")
