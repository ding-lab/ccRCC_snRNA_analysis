...
dam_selected_df <- fread(data.table = F, input = "./Resources/Analysis_Results/snatac/enriched_motifs/summarize_tf_motifs/summarize_sig_up_tf_diff_across_snatac_tumors/20201223.v2/DAMs_top.20201223.v2.tsv")
## input idemta data
